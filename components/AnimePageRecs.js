...
const AnimePageRecs = ({title, genre, img_url, score, rank, synopsis, onFavClick}) => {
    const {theme} = useTheme();

    return (
        <Container>
            <Column>
                <Text header_color={ThemeConfig[theme].body}>Similar Anime to {title}</Text>
                <Row>
                    <AnimePageRecCard 
                        title={title} 
                        genre={genre}
            ...
            >
                ...
                <ScoreCont>
                    <ScoreCont inside>
                        <Text info>
                            Score: <Text info para_color={ThemeConfig[theme].body}>{score}</Text>
                        </Text>
                    </ScoreCont>
                </ScoreCont>
